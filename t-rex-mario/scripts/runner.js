...
(function() {
    ...
    Runner.prototype = {
        ...
        update: function() {
            ...
            if (this.activated) {
                ...
                if (playAcheivementSound) {
                    document.getElementById('rex-scores').play();
        ...
        onKeyDown: function(e) {
                    ...
                    this.playSound(this.soundFx.BG);
            if (!this.crashed && (Runner.keycodes.JUMP[String(e.keyCode)] ||
                e.type == Runner.events.TOUCHSTART)) {
                if (!this.activated) {
                    //this.loadSounds();
                    this.activated = true;
                    document.getElementById('theme-song').currentTime = audioStart;
        ...
        gameOver: function() {
            ...
            document.getElementById('rex-died').play();
            document.getElementById('theme-song').currentTime = audioStart;
    ...
    Trex.prototype = {
        ...
        startJump: function() {
            if (!this.jumping) {
                document.getElementById('rex-jumps').play();
